/**
 * snakeEngine.js — NeonSerpent core game engine + constants.
 *
 * Extracted from os/apps/SnakeApp.js so the host shell can stay
 * focused on the cosmic chrome + side-rail wiring. The engine code
 * is otherwise unchanged from its v1.0 form (canvas2D rendering,
 * 4 power-ups, tiered food, combos, particle FX).
 *
 * Color constants here ARE adjusted to match the design package's
 * "Comet" palette — the snake reads as teal accent, the apple as
 * red-star, power-ups violet — without changing any gameplay logic.
 */
...
// Comet palette per the design package \u2014 snake teal-accent, apple
// red-star, power-ups violet. Other themes kept for the in-game picker.
const COLORS = {
    cyan:    { h: 168, s: 100, main: '#00e5c1', rgb: '0,229,193'   },
...
const FOOD_TIERS = [
    // Regular = "red comet apple" (#c5152e gradient) per design
    { id: 'regular', color: '#ff7a8a', glow: '#c5152e', points: 10,  lifespan: Infinity, spawnChance: 1   },
...
const POWERUP_TYPES = [
    // 'ghost' is the violet Slipstream diamond per design
    { id: 'ghost',  icon: '\uD83D\uDC7B', color: '#9b7bff', label: 'Slipstream', duration: 360 },
...
export { NeonSerpent, COLORS, FOOD_TIERS, POWERUP_TYPES, LS_KEY, CELL };
