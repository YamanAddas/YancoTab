// StuckPrompt.js — "No moves left" modal for Spider. Triggered when isStuck
...
export function showStuckPrompt(root, { onUndo, onNew, onClose }) {
  const card = el('div', { class: 'cosmic-win-card' }, [
    ...
    el('div', { class: 'cosmic-win-sub' }, 'The board is stuck and the stock is empty. Undo the last move or start a new deal.'),
    el('div', {
