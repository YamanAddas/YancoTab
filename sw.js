...
const CACHE_NAME = 'yancotab-v1.11.1-mail-search';
...
const PRECACHE = [
    ...
    './os/utils/url.js',
    './os/utils/safeSave.js',
    './os/utils/notes-utils.js',
    ...
    // Todo graph
    './os/apps/todo/engine/aggregate.js',
    './os/apps/todo/view/launchpad.js',
    './os/apps/todo/view/todayTab.js',
    './os/apps/todo/view/weekTab.js',
    './os/apps/todo/view/reviewTab.js',
    './os/apps/todo/view/reviewRail.js',
    './os/apps/todo/view/sideRail.js',
    './os/apps/todo/view/timeline.js',
    './os/apps/todo/view/rocket.js',
    ...
    './os/apps/pomodoro/view/timerRing.js',
    './os/apps/pomodoro/view/timerInfo.js',
    './os/apps/pomodoro/view/presetsRail.js',
    './os/apps/pomodoro/view/attachedRow.js',
    './os/apps/pomodoro/view/statsTab.js',
    './os/apps/pomodoro/view/weekGrid.js',
    './os/apps/pomodoro/view/seasonTab.js',
    './os/apps/pomodoro/view/settingsTab.js',
    './os/apps/pomodoro/view/sky.js',
    // Apps
    './os/apps/BrowserApp.js',
    // Browser graph
    './os/apps/browser/intents.js',
    './os/apps/browser/persistence.js',
    './os/apps/browser/engine/state.js',
    './os/apps/browser/engine/layout.js',
    './os/apps/browser/engine/migrate.js',
    './os/apps/browser/engine/visits.js',
    './os/apps/browser/view/toolbar.js',
    './os/apps/browser/view/sideRail.js',
    './os/apps/browser/view/starMap.js',
    './os/apps/browser/view/portal.js',
    './os/apps/browser/view/clusterOrbits.js',
    './os/apps/browser/view/drag.js',
    './os/apps/browser/view/tabsTab.js',
    './os/apps/browser/view/historyTab.js',
    ...
    // Notes graph
    './os/apps/notes/persistence.js',
    './os/apps/notes/engine/meta.js',
    './os/apps/notes/engine/layout.js',
    './os/apps/notes/engine/filters.js',
    './os/apps/notes/engine/filterTime.js',
    './os/apps/notes/engine/wikilinks.js',
    './os/apps/notes/engine/resourceKey.js',
    './os/apps/notes/view/sideRail.js',
    './os/apps/notes/view/cosmosStage.js',
    './os/apps/notes/view/listTab.js',
    './os/apps/notes/view/calendarTab.js',
    './os/apps/notes/view/timelineTab.js',
    './os/apps/notes/view/star.js',
    './os/apps/notes/view/dragStar.js',
    './os/apps/notes/view/searchBeam.js',
    ...
    // Settings graph
    './os/apps/settings/components.js',
    './os/apps/settings/persistence.js',
    './os/apps/settings/engine/privacyStats.js',
    './os/apps/settings/engine/rituals.js',
    './os/apps/settings/engine/syncLog.js',
    './os/apps/settings/view/bay.js',
    './os/apps/settings/view/settingsBay.js',
    './os/apps/settings/view/privacyBay.js',
    './os/apps/settings/view/syncBay.js',
    './os/apps/settings/view/rituals.js',
    './os/apps/settings/view/sideRail.js',
    './os/apps/SnakeApp.js',
    ...
    // Lazy app entries reachable only through boot.js import()
    './os/apps/MapsApp.js',
    // Games
    ...
    // Solitaire UI + reducer
    './os/apps/games/solitaire/engine/reducer.js',
    './os/apps/games/solitaire/intents.js',
    './os/apps/games/solitaire/persistence.js',
    './os/apps/games/solitaire/view/drag.js',
    './os/apps/games/solitaire/ui/StartScreen.js',
    './os/apps/games/solitaire/ui/NewGameMenu.js',
    './os/apps/games/solitaire/ui/SettingsPanel.js',
    './os/apps/games/solitaire/ui/StatsPanel.js',
    './os/apps/games/solitaire/ui/StuckPrompt.js',
    './os/apps/games/solitaire/ui/WinOverlay.js',
    './os/apps/games/solitaire/ui/hintGlow.js',
    './os/apps/games/solitaire/ui/keyboard.js',
    './os/apps/games/solitaire/ui/winCascade.js',
    './os/ui/sfx.js',
    './os/ui/motion.js',
    './os/ui/cardFace.js',
    './css/cosmic/card.css',
    ...
    // Photos app + editor
    './os/apps/PhotosApp.js',
    './os/apps/photos/PhotoEditor.js',
    './os/apps/photos/WallpaperManager.js',
    ...
    // PDF Reader app + v3 reader modules
    './os/apps/PdfReaderApp.js',
    './os/apps/pdf/v3/readerZoom.js',
    './os/apps/pdf/v3/readerColor.js',
    './os/apps/pdf/v3/readerOps.js',
    './os/apps/pdf/v3/readerViewMode.js',
